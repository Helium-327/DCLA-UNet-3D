...
class SlimSepUNetv3(SlimSepUNetv2):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 kernel_size=7, 
        ...
        super(SlimSepUNetv3, self).__init__(
...
class SlimSepUNetv3_LKDCLA(SlimSepUNetv2_LKDCLA):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 kernel_size=7, 
        ...
        super(SlimSepUNetv3_LKDCLA, self).__init__(
            in_channels=in_channels,
            out_channels=out_channels,
            kernel_size=kernel_size,    
            f_list=f_list,
...
class SlimSepUNetv3_LiteDASPP(SlimSepUNetv2_LiteDASPP):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 kernel_size=7, 
        ...
        super(SlimSepUNetv3_LiteDASPP, self).__init__(
            in_channels=in_channels,
            out_channels=out_channels,
            kernel_size=kernel_size,    
            f_list=f_list,
...
class SlimSepUNetv3_LiteDASPP_LKDCLA(SlimSepUNetv3_LiteDASPP):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 kernel_size=7, 
        ...
        super(SlimSepUNetv3_LiteDASPP_LKDCLA, self).__init__(
            in_channels=in_channels,
            out_channels=out_channels,
            kernel_size=kernel_size,    
            f_list=f_list,
        ...
        # self.dcla = DynamicCrossLevelAttentionv2(ch_list=f_list, feats_size=[128, 64, 32, 16], min_size=8, kernel_size=(7, 7, 5, 3) )# @2
    def forward(self, x):
        # Encoder
...
if __name__ == "__main__":
    test_unet(model_class=SlimSepUNetv3_LKDCLA, batch_size=1)   