...
from nnArchitecture.nets.slim_sep_unets.v3 import (
    SlimSepUNetv3,
    SlimSepUNetv3_LKDCLA,
    SlimSepUNetv3_LiteDASPP,
    SlimSepUNetv3_LiteDASPP_LKDCLA
)
...
class SlimSepUNetv4(SlimSepUNetv3):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 kernel_size=7, 
        ...
        super(SlimSepUNetv4, self).__init__(
        ...
        self.Conv1 = MultiKernelSlimUpBlockv2(in_channels, f_list[0], kernel_size=3, dilations=[1, 2, 3])
        self.Conv2 = MultiKernelSlimUpBlockv2(f_list[0], f_list[1], kernel_size=3, dilations=[1, 2, 3])
        self.Conv3 = MultiKernelSlimUpBlockv2(f_list[1], f_list[2], kernel_size=3, dilations=[1, 2, 3])
        self.Conv4 = MultiKernelSlimUpBlockv2(f_list[2], f_list[3], kernel_size=3, dilations=[1, 2, 3])
...
class SlimSepUNetv4_LiteDASPP(SlimSepUNetv3_LiteDASPP):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 kernel_size=7, 
        ...
        super(SlimSepUNetv4_LiteDASPP, self).__init__(
            in_channels=in_channels,
            out_channels=out_channels,
            kernel_size=kernel_size,    
            f_list=f_list,
...
class SlimSepUNetv4_LiteDASPP_LKDCLA(SlimSepUNetv3_LiteDASPP_LKDCLA):
    def __init__(self,
                 in_channels=4,
                 out_channels=4,
                 kernel_size=7,
        ...
        super(SlimSepUNetv4_LiteDASPP_LKDCLA, self).__init__(
            in_channels=in_channels,
            out_channels=out_channels,
            kernel_size=kernel_size,
            f_list=f_list,
        ...
        self.dcla = DynamicCrossLevelAttentionv2(ch_list=f_list, feats_size=[128, 64, 32, 16], min_size=8, kernel_size=(11, 7, 5, 3))
...
if __name__ == "__main__":
    test_unet(model_class=SlimSepUNetv4_LiteDASPP_LKDCLA, batch_size=1)   