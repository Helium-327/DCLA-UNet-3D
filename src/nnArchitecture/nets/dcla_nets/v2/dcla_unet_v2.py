...
*      AUTHOR: @Junyin Xiong
*      DESCRIPTION: 构建 DCLA UNet v2 训练模型
*      VERSION: v2
*      FEATURES: 
               - ✅构建 DCLA UNet v2 系列模型结构
...
from nnArchitecture.nets.dcla_nets.v2 import SLK, DCLA, MSF
from nnArchitecture.nets.dcla_nets.v2.baseline import ResUNetBaseline_S as baseline
...
class ResUNetBaseline_S_SLK_v2(baseline):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
...
class ResUNetBaseline_S_LiteMSF_v2(baseline):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_LiteMSF_v2, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear, 
...
class ResUNetBaseline_S_DCLA_LiteMSF_v2(ResUNetBaseline_S_LiteMSF_v2):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_DCLA_LiteMSF_v2, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear, 
...
class ResUNetBaseline_S_SLK_LiteMSF_v2(baseline):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_SLK_LiteMSF_v2, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear,  
...
class ResUNetBaseline_S_DCLA_v2(baseline):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
class ResUNetBaseline_S_DCLA_SLK_v2(ResUNetBaseline_S_DCLA_v2):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
class ResUNetBaseline_S_DCLA_LiteMSF_v2(DCLA_UNet_v2):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
if __name__ == "__main__":
    test_unet(model_class=DCLA_UNet_v2, batch_size=1)   
    model = DCLA_UNet_v2(in_channels=4, out_channels=4)
