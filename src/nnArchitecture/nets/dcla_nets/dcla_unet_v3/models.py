...
class ResUNetBaseline_S_SLK_v3(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
...
class ResUNetBaseline_S_MSF_v3(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
class ResUNetBaseline_S_DCLA_MSF_v3(ResUNetBaseline_S_MSF_v3):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
class ResUNetBaseline_S_SLK_MSF_v3(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_SLK_MSF_v3, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear,  
...
class ResUNetBaseline_S_DCLA_v3(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
