...
from nnArchitecture.nets.dcla_nets.dcla_unet_250615.modules import *
...
class DCLA_UNet_250615(nn.Module):
    __remark__ = """
    [Version]: 250615
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_250615, self).__init__()
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
...
class DCLA_UNet_NoRes_250615(nn.Module):
    __remark__ = """
    [Version]: 250615
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_NoRes_250615, self).__init__()
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
        self.Conv1 = self._make_encoder_layer(in_channels, f_list[0], kernel_size=kernel_size, se_ratio=se_ratio)
        self.Conv2 = self._make_encoder_layer(f_list[0], f_list[1], kernel_size=kernel_size, se_ratio=se_ratio)
        self.Conv3 = self._make_encoder_layer(f_list[1], f_list[2], kernel_size=kernel_size, se_ratio=se_ratio)
        ...
        self.dcla = DynamicCrossLevelAttentionv2(ch_list=f_list, feats_size=[128, 64, 32, 16], min_size=8, squeeze_kernel=1, down_kernel=[7], fusion_kernel=7)
        self.Up4 = UpSample(f_list[3], f_list[3], trilinear)
        self.Up3 = UpSample(f_list[2], f_list[2], trilinear)
        self.Up2 = UpSample(f_list[1], f_list[1], trilinear)
        self.Up1 = UpSample(f_list[0], f_list[0], trilinear)
...
class DCLA_UNet_DCLAv2_NoRes_250615(DCLA_UNet_NoRes_250615):
    __remark__ = """
    [Version]: 250615
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(DCLA_UNet_DCLAv2_NoRes_250615, self).__init__()
...
if __name__ == "__main__":
    test_unet(model_class=DCLA_UNet_NoRes_250615, batch_size=1)   
    model = DCLA_UNet_NoRes_250615(in_channels=4, out_channels=4)
