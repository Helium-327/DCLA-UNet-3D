...
class Base_SLK_250606(DCLA_UNet_250606):
    __remark__ = """
    [Version]: 250606
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(Base_SLK_250606, self).__init__()
        if hasattr(self, "dcla"):
            delattr(self, "dcla")
...
class Base_SLK_DCLA_250606(DCLA_UNet_250606):
    __remark__ = """
    [Version]: 250606
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(Base_SLK_DCLA_250606, self).__init__()
...
if __name__ == "__main__":
    test_unet(model_class=DCLA_UNet_250606, batch_size=1)   
    model = DCLA_UNet_250606(in_channels=4, out_channels=4)
