...
# class DCLA_UNet_250606(nn.Module):
#     __remark__ = """
#     [Version]: 250606
#     [Author]: Junyin Xiong
#     [Features]
...
#                  dropout_rate=0
#                  ):
#         super(DCLA_UNet_250606, self).__init__()
#         self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
#         self.Conv1 = ResNeXtConv(in_channels, f_list[0], kernel_size=kernel_size)
#         self.Conv2 = ResNeXtConv(f_list[0], f_list[1], kernel_size=kernel_size)
#         self.Conv3 = ResNeXtConv(f_list[1], f_list[2], kernel_size=kernel_size)
...
class DCLA_UNet_250606(nn.Module):
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_250606, self).__init__()
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
        self.Conv1 = self._make_encoder_layer(in_channels, f_list[0], kernel_size=kernel_size, se_ratio=8)
        self.Conv2 = self._make_encoder_layer(f_list[0], f_list[1], kernel_size=kernel_size, se_ratio=8)
        self.Conv3 = self._make_encoder_layer(f_list[1], f_list[2], kernel_size=kernel_size, se_ratio=8)
        self.Conv4 = self._make_encoder_layer(f_list[2], f_list[3], kernel_size=kernel_size, se_ratio=8)
    ...
    def _make_encoder_layer(self, in_channels, out_channels, kernel_size, se_ratio=8):
        return nn.Sequential(
            ResNeXtConv(in_channels, out_channels//2, kernel_size=3),
            MutilScaleFusionBlock(out_channels//2, out_channels, dilations=[1, 2, 3]),
    ...
    def _make_decoder_layer(self, 
        ...
        return nn.Sequential(
            SqueezeExcitation(in_channels, reduction_ratio=se_ratio),
            nn.Conv3d(in_channels, out_channels, kernel_size=1),
            get_norm(norm_type, out_channels),
            get_act(act_type),
            MutilScaleFusionBlock(out_channels, out_channels, dilations=[1, 2, 3], norm_type=norm_type, act_type=act_type)
        )
...
class DCLA_UNet_withoutDCLA_250606(DCLA_UNet_250606):
    __remark__ = """
    [Version]: 250606
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_withoutDCLA_250606, self).__init__()
...
class Base_ResNeXt_250606(DCLA_UNet_250606):
    __remark__ = """
    [Version]: 250606
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(Base_ResNeXt_250606, self).__init__()
        if hasattr(self, "dcla"):
            delattr(self, "dcla")
...
class Base_ResNeXt_DCLA_250606(DCLA_UNet_250606):
    __remark__ = """
    [Version]: 250606
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(Base_ResNeXt_DCLA_250606, self).__init__()
...
class Base_MSF_250606(DCLA_UNet_250606):
    __remark__ = """
    [Version]:250606
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(Base_MSF_250606, self).__init__()
        if hasattr(self, "dcla"):
            delattr(self, "dcla")
...
class Base_MSF_DCLA_250606(DCLA_UNet_250606):
    __remark__ = """
    [Version]: 250606
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(Base_MSF_DCLA_250606, self).__init__()
...
if __name__ == "__main__":
    test_unet(model_class=Base_MSF_DCLA_250606, batch_size=1)   
    model = Base_MSF_DCLA_250606(in_channels=4, out_channels=4)
