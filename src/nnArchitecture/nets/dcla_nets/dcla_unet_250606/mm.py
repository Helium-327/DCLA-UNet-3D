...
class SlimLargeKernelBlockv4(nn.Module): 
    def __init__(self, 
        ...
        self.resblock = ResDWAConvBlock(out_channels, out_channels, kernel_size=kernel_size, norm_type=norm_type, act_type=act_type)
...
class EfficientAttentionBlock(nn.Module):
    def __init__(self, 
        ...
        super().__init__()
        self.ca = LightweightChannelAttention3D(channels, ratio=ratio)
        self.sa = LightweightSpatialAttention3D(kernel_size=spatial_kernal)
