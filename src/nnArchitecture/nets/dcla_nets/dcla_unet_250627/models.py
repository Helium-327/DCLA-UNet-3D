...
from nnArchitecture.nets.dcla_nets.dcla_unet_250627.modules import *
...
class DCLA_UNet_250627(nn.Module):
    __remark__ = """
    [Version]: 250627
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_250627, self).__init__()
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
...
class DCLA_UNet_NoRes_250627(nn.Module):
    __remark__ = """
    [Version]: 250627
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_NoRes_250627, self).__init__()
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
        self.Conv1 = self._make_encoder_layer(in_channels, f_list[0], kernel_size=kernel_size, se_ratio=se_ratio)
        self.Conv2 = self._make_encoder_layer(f_list[0], f_list[1], kernel_size=kernel_size, se_ratio=se_ratio)
        self.Conv3 = self._make_encoder_layer(f_list[1], f_list[2], kernel_size=kernel_size, se_ratio=se_ratio)
...
class DCLA_UNet_DCLAv2_NoRes_250627(DCLA_UNet_NoRes_250627):
    __remark__ = """
    [Version]: 250627
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(DCLA_UNet_DCLAv2_NoRes_250627, self).__init__()
...
class SLK_UNet_250627(DCLA_UNet_NoRes_250627):
    __remark__ = """
    [Version]: 250627
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(SLK_UNet_250627, self).__init__()
...
class MSF_UNet_250627(DCLA_UNet_NoRes_250627):
    __remark__ = """
    [Version]: 250627
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(MSF_UNet_250627, self).__init__()
        if hasattr(self, "dcla"):
            delattr(self, "dcla")
...
class SLK_MSF_UNet_250627(DCLA_UNet_NoRes_250627):
    __remark__ = """
    [Version]: 250627
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(SLK_MSF_UNet_250627, self).__init__()
        if hasattr(self, "dcla"):
            delattr(self, "dcla")
...
if __name__ == "__main__":
    test_unet(model_class=DCLA_UNet_NoRes_250627, batch_size=1)   
    model = DCLA_UNet_NoRes_250627(in_channels=4, out_channels=4)
