...
*      FEATURES: 
               ...
               - ✅解码器使用MSF多尺度融合模块
               - #TODO: 解码器增强，融合使用DAC 7x7替换 Conv1x1s
*      STATE:     开发中
*      CHANGE ON: 
=================================================
'''
...
class DCLA_UNet_v1_1(nn.Module):
    __remark__ = """
    [Version]: V1.2
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_v1_1, self).__init__()
...
class MutilScaleFusionBlock(nn.Module): #(MLP)
    def __init__(self, 
        ...
        if use_attn:
            self.ca = LightweightChannelAttention3D(mid_channels, ratio=ratio)
...
if __name__ == "__main__":
    test_unet(model_class=DCLA_UNet_v1_1, batch_size=1)   
    model = DCLA_UNet_v1_1(in_channels=4, out_channels=4)
