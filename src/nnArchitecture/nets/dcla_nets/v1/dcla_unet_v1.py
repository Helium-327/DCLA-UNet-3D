...
from nnArchitecture.nets.dcla_nets.v1.baseline import ResUNetBaseline_S as baseline
from nnArchitecture.nets.dcla_nets.v1 import SLK, DCLA, MSF
...
class ResUNetBaseline_S_SLK_v1(baseline):
    __remark__ = """
    [Version]: V1
    [Author]: Junyin Xiong
...
class ResUNetBaseline_S_LiteMSF_v1(baseline):
    __remark__ = """
    [Version]: V1
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_LiteMSF_v1, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear, 
...
class ResUNetBaseline_S_DCLA_LiteMSF_v1(ResUNetBaseline_S_LiteMSF_v1):
    __remark__ = """
    [Version]: V1
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_DCLA_LiteMSF_v1, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear
...
class ResUNetBaseline_S_SLK_LiteMSF_v1(DCLA_UNet_v1):
    __remark__ = """
    [Version]: V1
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_SLK_LiteMSF_v1, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear
...
class ResUNetBaseline_S_DCLA_v1(baseline):
    __remark__ = """
    [Version]: V1
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
if __name__ == "__main__":
    test_unet(model_class=DCLA_UNet_v1, batch_size=1)   
