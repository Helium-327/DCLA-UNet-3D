...
from nnArchitecture.nets.dcla_nets.dcla_unet_250604.mm import *
...
class DCLA_UNet_250604(nn.Module):
    __remark__ = """
    [Version]: 250604
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_250604, self).__init__()
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
        self.Conv1 = ResNeXtConv(in_channels, f_list[0], kernel_size=kernel_size)
        self.Conv2 = ResNeXtConv(f_list[0], f_list[1], kernel_size=kernel_size)
        self.Conv3 = ResNeXtConv(f_list[1], f_list[2], kernel_size=kernel_size)
...
class DCLA_UNet_withoutDCLA_250604(DCLA_UNet_250604):
    __remark__ = """
    [Version]: 250604
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(DCLA_UNet_withoutDCLA_250604, self).__init__()
...
class Base_ResNeXt_250604(DCLA_UNet_250604):
    __remark__ = """
    [Version]: 250604
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(Base_ResNeXt_250604, self).__init__()
        if hasattr(self, "dcla"):
            delattr(self, "dcla")
...
class Base_ResNeXt_DCLA_250604(DCLA_UNet_250604):
    __remark__ = """
    [Version]: 250604
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self, 
        ...
        super(Base_ResNeXt_DCLA_250604, self).__init__()
...
class Base_MSF_250604(DCLA_UNet_250604):
    __remark__ = """
    [Version]:250604
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(Base_MSF_250604, self).__init__()
        if hasattr(self, "dcla"):
            delattr(self, "dcla")
...
class Base_MSF_DCLA_250604(DCLA_UNet_250604):
    __remark__ = """
    [Version]: 250604
    [Author]: Junyin Xiong
    [Features]
    ...
    def __init__(self,
        ...
        super(Base_MSF_DCLA_250604, self).__init__()
...
if __name__ == "__main__":
    test_unet(model_class=Base_ResNeXt_DCLA_250604, batch_size=1)   
    model = Base_ResNeXt_DCLA_250604(in_channels=4, out_channels=4)
