...
from nnArchitecture.nets.dcla_nets.dcla_unet_v4.mm import (
    ResConv3D_S_BN,
...
class ResUNetBaseline_S_SLK_v4(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_SLK_v4, self).__init__(
...
class ResUNetBaseline_S_DCLA_SLK_v4(ResUNetBaseline_S_SLK_v4):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_DCLA_SLK_v4, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear, 
...
class ResUNetBaseline_S_MSF_v4(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_MSF_v4, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear, 
...
class ResUNetBaseline_S_DCLA_MSF_v4(ResUNetBaseline_S_MSF_v4):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_DCLA_MSF_v4, self).__init__(
                in_channels=in_channels, 
                out_channels=out_channels,
                f_list=f_list, 
                trilinear=trilinear, 
...
class ResUNetBaseline_S_SLK_MSF_v4(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
class ResUNetBaseline_S_DCLA_v4(ResUNetBaseline_S):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
    ...
    def __init__(self,
        ...
        super(ResUNetBaseline_S_DCLA_v4, self).__init__(
                in_channels=in_channels,
                out_channels=out_channels,
                f_list=f_list,
                trilinear=trilinear,
...
class ResUNetBaseline_S_DCLA_SLK_v4(ResUNetBaseline_S_DCLA_v4):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
...
class ResUNetBaseline_S_DCLA_MSF_v4(DCLA_UNet_v4):
    __remark__ = """
    [Version]: V2
    [Author]: Junyin Xiong
    [basline]: ResUNetBaseline_S
