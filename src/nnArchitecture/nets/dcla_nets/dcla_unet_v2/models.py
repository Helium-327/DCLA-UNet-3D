...
class DCLA_UNet_v2_6(nn.Module):
    ...
    def __init__(self, 
        ...
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
        self.Conv1 = MutilScaleFusionBlock(in_channels, f_list[0],  fusion_kernel=7)
        self.Conv2 = MutilScaleFusionBlock(f_list[0], f_list[1],  fusion_kernel=7)
        self.Conv3 = MutilScaleFusionBlock(f_list[1], f_list[2],  fusion_kernel=7)
        self.Conv4 = MutilScaleFusionBlock(f_list[2], f_list[3],  fusion_kernel=7)
...
if __name__ == "__main__":
    test_unet(model_class=DCLA_UNet_v2_6, batch_size=1)   
    model = DCLA_UNet_v2_6(in_channels=4, out_channels=4)
