...
class ResUNet3D_S(nn.Module):
    def __init__(self, in_channels=4, out_channels=4, groups=16, f_list=[32, 64, 128, 256], trilinear=True):
        super(ResUNet3D_S, self).__init__()
        
        self.MaxPool = nn.MaxPool3d(kernel_size=2, stride=2)
        self.Conv1 = ResConv3D_S_BN(in_channels, f_list[0], groups=1)
        self.Conv2 = ResConv3D_S_BN(f_list[0], f_list[1], groups=groups)
        self.Conv3 = ResConv3D_S_BN(f_list[1], f_list[2], groups=groups)
        self.Conv4 = ResConv3D_S_BN(f_list[2], f_list[3], groups=groups)
        
        self.bottleneck = ResConv3D_S_BN(f_list[3], f_list[3], groups=groups)
        
        self.Up5 = UpSample(f_list[3], f_list[3], trilinear)
        self.UpConv5 = ResConv3D_S_BN(f_list[3]*2, f_list[3]//2, groups=groups)
        
        self.Up4 = UpSample(f_list[2], f_list[2], trilinear)
        self.UpConv4 = ResConv3D_S_BN(f_list[2]*2, f_list[2]//2, groups=groups)
        
        self.Up3 = UpSample(f_list[1], f_list[1], trilinear)
        self.UpConv3 = ResConv3D_S_BN(f_list[1]*2, f_list[1]//2, groups=groups)
        
        self.Up2 = UpSample(f_list[0], f_list[0], trilinear)
        self.UpConv2 = ResConv3D_S_BN(f_list[0]*2, f_list[0], groups=groups)
...
""" =========================== Net2: +DASPP =================================================="""
class ResUNet_S_DASPP(ResUNet3D_S):
    def __init__(self, in_channels=4, 
                 out_channels=4, 
                 f_list=[32, 64, 128, 256], 
                 trilinear=True
                 ):
        super(ResUNet_S_DASPP, self).__init__(
...
""" =========================== Net2: +DASPP + MADG ========================================"""
class ResUNet_S_MADG_DASPP(ResUNet_S_DASPP):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 f_list=[32, 64, 128, 256], 
        ...
        super(ResUNet_S_MADG_DASPP, self).__init__(
            in_channels=in_channels, 
            out_channels=out_channels, 
            f_list=f_list, 
            trilinear=trilinear)
...
class ResUNet_S_MADG_DASPP_DCLA(ResUNet_S_MADG_DASPP):
    def __init__(self, 
                in_channels=4, 
                out_channels=4, 
                f_list=[32, 64, 128, 256], 
        ...
        super(ResUNet_S_MADG_DASPP_DCLA, self).__init__(
            in_channels=in_channels, 
            out_channels=out_channels, 
            f_list=f_list, 
            trilinear=trilinear)
...
class ResUNet_S_DCLA(ResUNet3D_S):
    def __init__(self, 
                in_channels=4, 
                out_channels=4, 
                f_list=[32, 64, 128, 256], 
        ...
        super(ResUNet_S_DCLA, self).__init__(
            in_channels=in_channels, 
            out_channels=out_channels, 
            f_list=f_list, 
            trilinear=trilinear)
...
class ResUNet_S_DCLA_AG(ResUNet_S_DCLA):
    def __init__(self, 
                in_channels=4, 
                out_channels=4, 
                f_list=[32, 64, 128, 256], 
        ...
        super(ResUNet_S_DCLA_AG, self).__init__(
            in_channels=in_channels, 
            out_channels=out_channels, 
            f_list=f_list, 
            trilinear=trilinear)
...
class ResUNet_S_DCLA_AG_DASPP(ResUNet_S_DCLA_AG):
    def __init__(self, 
                in_channels=4, 
                out_channels=4, 
                f_list=[32, 64, 128, 256], 
        ...
        super(ResUNet_S_DCLA_AG_DASPP, self).__init__(
            in_channels=in_channels, 
            out_channels=out_channels, 
            f_list=f_list, 
            trilinear=trilinear)
...
class ResUNet_S_DCLA_MADG(ResUNet_S_DCLA):
    def __init__(self, 
                in_channels=4, 
                out_channels=4, 
                f_list=[32, 64, 128, 256], 
        ...
        super(ResUNet_S_DCLA_MADG, self).__init__(
            in_channels=in_channels, 
            out_channels=out_channels, 
            f_list=f_list, 
            trilinear=trilinear)
...
class ResUNet_S_DCLA_MADG_DASPP(ResUNet_S_DCLA_MADG):
    def __init__(self, 
                in_channels=4, 
                out_channels=4, 
                f_list=[32, 64, 128, 256], 
        ...
        super(ResUNet_S_DCLA_MADG_DASPP, self).__init__(
            in_channels=in_channels, 
            out_channels=out_channels, 
            f_list=f_list, 
            trilinear=trilinear)
...
if __name__ == "__main__":
    test_unet(model_class=ResUNet3D_S, batch_size=1)   
