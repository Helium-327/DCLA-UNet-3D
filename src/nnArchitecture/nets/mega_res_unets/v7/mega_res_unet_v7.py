...
class MegaResUNetv7(nn.Module):
    def __init__(self, 
        ...
        super(MegaResUNetv7, self).__init__()
...
class MegaResUNetv7_LKDCLA(MegaResUNetv7):
    def __init__(self, 
                 in_channels=4, 
                 out_channels=4, 
                 kernel_size=7, 
        ...
        super(MegaResUNetv7_LKDCLA, self).__init__(
...
if __name__ == "__main__":
    test_unet(model_class=MegaResUNetv7, batch_size=1)   
